...
if __name__ == '__main__':
    ...
    gt = np.load('C:/Users/fly/Downloads/t2200_result/gt/t2gt200.npy')
    gt = gt[:,:,:,0]
    print(gt.shape)

    'MDFA_Net  U_Net FCN MSCMR fcn(1) NDD_Net Lambda'

    pred1 = np.load('C:/Users/fly/Downloads/t2200_result/MDFA_Net/MDFA_Net_t2200_result.npy')
    pred1=pred1[:,:,:,0]
    print(pred1.shape)
    result1=avg_surface_distance_symmetric(test=pred1, reference=gt, confusion_matrix=None, nan_for_nonexisting=True, voxel_spacing=None, connectivity=2)
    print(result1)

    pred1 = np.load('C:/Users/fly/Downloads/t2200_result/U_Net/U_Net_t2200_result.npy')
    pred1=pred1[:,:,:,0]
    print(pred1.shape)
    result1=avg_surface_distance_symmetric(test=pred1, reference=gt, confusion_matrix=None, nan_for_nonexisting=True, voxel_spacing=None, connectivity=2)
    print(result1)

    pred1 = np.load('C:/Users/fly/Downloads/t2200_result/MSCMR/MSCMR_t2200_result.npy')
    pred1=pred1[:,:,:,0]
    print(pred1.shape)
    result1=avg_surface_distance_symmetric(test=pred1, reference=gt, confusion_matrix=None, nan_for_nonexisting=True, voxel_spacing=None, connectivity=2)
    print(result1)

    pred1 = np.load('C:/Users/fly/Downloads/t2200_result/fcn(1)/fcn(1)_t2200_result.npy')
    pred1=pred1[:,:,:,0]
    print(pred1.shape)
    result1=avg_surface_distance_symmetric(test=pred1, reference=gt, confusion_matrix=None, nan_for_nonexisting=True, voxel_spacing=None, connectivity=2)
    print(result1)

    pred1 = np.load('C:/Users/fly/Downloads/t2200_result/NDD_Net/NDD_Net_t2200_result.npy')
    pred1=pred1[:,:,:,0]
    print(pred1.shape)
    result1=avg_surface_distance_symmetric(test=pred1, reference=gt, confusion_matrix=None, nan_for_nonexisting=True, voxel_spacing=None, connectivity=2)
    print(result1)

    pred1 = np.load('C:/Users/fly/Downloads/t2200_result/Lambda/Lambda_t2200_result.npy')
    pred1=pred1[:,:,:,0]
    print(pred1.shape)
    result1=avg_surface_distance_symmetric(test=pred1, reference=gt, confusion_matrix=None, nan_for_nonexisting=True, voxel_spacing=None, connectivity=2)
    print(result1)
